(function () {
    ...
    app.controller('loginCtrl', function ($scope, $http, $location, $rootScope, toastr) {
        ...
        $scope.login = function () {
            ...
            commonSetHTTPService('Post', fd, 'teacher/login', function (result) {
                $classes = result;
                window.location = "http://www.merikitab.in/schoolkit/app/teacher/#!/";
            });
        }
        ...
        $scope.generateOtp = function () {
            var fd = new FormData();
            fd.append('email', $scope.email);
            commonGetHTTPService('Post', fd, 'teacher/forget_password', function (result) {
                $scope.otp = "";
                $scope.password = "";
                $scope.confirm_password = "";
                toastr.info("An Email or SMS ha been sent with OTP!", 'Check your Email/Mobile');
                window.location = "http://www.merikitab.in/schoolKit/app/teacher/login.html#changePassword";
            });
        }
        ...
        $scope.checkOtp = function () {
            ...
            commonSetHTTPService('Post', fd, 'teacher/check_otp', function (result) {
