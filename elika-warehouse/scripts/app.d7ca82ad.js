...
// var baseUrl = 'http://127.0.0.1:8080/';
>>>>>>> 3cd4eed5da3583fd51092b98857e57b88d7b1922
var app = angular
  .module('minovateApp', [
    'ngAnimate',
    'ngCookies',
  ...
  .config(['$stateProvider', '$urlRouterProvider', function($stateProvider, $urlRouterProvider) {
    ...
    .state('app.profile-settings', {
      ...
      templateUrl: 'views/tmpl/profile-settings.html'
    })
    ...
    .state('app.notifications', {
      ...
      templateUrl: 'views/tmpl/notifications.html'
    })
	...
	.state('app.inventory', {
	  ...
	  template: '<div ui-view></div>'
		...
		//inventory devices
		.state('app.inventory.devices', {
		  url: '/devices',
		  controller: 'DeviceCtrl',
		  templateUrl: 'views/tmpl/inventory/devices.html'
		})
		
			//inventory view-device
			.state('app.inventory.view-device', {
			  url: '/view-device/:device_id',
			  controller: 'ViewDeviceCtrl',
			  templateUrl: 'views/tmpl/inventory/view-device.html'
			})
			
			//inventory diagnostic
			.state('app.inventory.diagnostic', {
			  url: '/diagnostic',
			  controller: 'DiagnosticCtrl',
			  templateUrl: 'views/tmpl/inventory/diagnostic.html'
			})
			
			//inventory edit-device
			.state('app.inventory.edit-device', {
			  url: '/edit-device/:device_id',
			  controller: 'EditDeviceCtrl',
			  templateUrl: 'views/tmpl/inventory/edit-device.html'
			})
	...
	.state('app.firmware', {
	  ...
	  template: '<div ui-view></div>'
		...
		.state('app.firmware.firmware-management', {
		  url: '/firmware-management',
		  controller: 'FirmwareManagementCtrl',
		  templateUrl: 'views/tmpl/firmware/firmware-management.html'
		})
	...
	//monitor-diagnostics-and-reported-issues
	.state('app.monitor-diagnostics-and-reported-issues', {
	  url: '/Monitor-Diagnostics-and-Reported-Issues',
	  controller: 'MDandRICtrl',
	  templateUrl: 'views/tmpl/monitor-diagnostics-and-reported-issues.html'
	})
	...
	//administrator
		.state('app.administrator', {
		  ...
		  template: '<div ui-view></div>'
			...
			//administrator roles
			.state('app.administrator.roles', {
			  url: '/roles',
			  controller: 'RoleCtrl',
			  templateUrl: 'views/tmpl/administrator/roles.html'
			})
			
				//administrator add-roles
				.state('app.administrator.add-roles', {
				  url: '/add-roles',
				  controller: 'AddRolesCtrl',
				  templateUrl: 'views/tmpl/administrator/add-roles.html'
				})
			...
			//administrator admin
			.state('app.administrator.admin', {
			  url: '/admin',
			  controller: 'AdminCtrl',
			  templateUrl: 'views/tmpl/administrator/admin.html'
			})
			
				//administrator admin-profile
				.state('app.administrator.admin-profile', {
				  url: '/admin-profile',
...
/**
 * @ngdoc function
 * @name minovateApp.controller:ProfileSettingsCtrl
 * @description
 * # ProfileSettingsCtrl
 * Controller of the minovateApp
 */
app
  .controller('ProfileSettingsCtrl', function ($scope, $state) {
    $scope.page = {
...
/**
 * @ngdoc function
 * @name minovateApp.controller:NotificationsCtrl
 * @description
 * # NotificationsCtrl
 * Controller of the minovateApp
 */
...
/**
 * @ngdoc function
 * @name minovateApp.controller:DiagnosticCtrl
 * @description
 * # DiagnosticCtrl
 * Controller of the minovateApp
 */
app
  .controller('DiagnosticCtrl', function ($scope, $state) {
    $scope.page = {
...
/**
 * @ngdoc function
 * @name minovateApp.controller:MDandRICtrl
 * @description
 * # MDandRICtrl
 * Controller of the minovateApp
 */
app
  .controller('MDandRICtrl', function ($scope, $state) {
    $scope.page = {
 ...
 */
app
  .controller('ViewRoleCtrl', function ($scope, $http, $mdDialog, $state) {
     $scope.page = {
      title: 'Role Details',
    };
    ...
    $scope.showConfirm = function(ev) {
		...
		$mdDialog.show(confirm).then(function() {
			$state.go('app.administrator.roles');
		}, function() {
...
/**
 * @ngdoc function
 * @name minovateApp.controller:EditRolesCtrl
 * @description
 * # EditRolesCtrl
 * Controller of the minovateApp
 */
app
  .controller('EditRolesCtrl', function ($scope, $http) {
     $scope.page = {
      title: 'Edit Roles',
    };
...
app
  .controller('AdminCtrl', function ($scope, $mdDialog, $http) {
	...
	$http.get('http://localhost:8080/elika-warehouse/json/admin.json').success(function(response){
...
/**
 * @ngdoc function
 * @name minovateApp.controller:AdminProfileCtrl
 * @description
 * # AdminProfileCtrl
 * Controller of the minovateApp
 */
app
  .controller('AdminProfileCtrl', function ($scope, $http, $mdDialog, $state) {
     $scope.page = {
      title: 'Admin Profile',
    };
    ...
    $scope.showConfirm = function(ev) {
		...
		.targetEvent(ev);
		$mdDialog.show(confirm).then(function() {
			$state.go('app.administrator.admin');
		}, function() {
			$scope.result = 'You decided to keep admin.';
			$scope.statusclass = 'alert alert-success alert-dismissable';
		});
...
/**
 * @ngdoc directive
 * @name minovateApp.directive:backButton
 * @description
 * # backButton
 */
...
app
  ...
  .controller('ActivebtnCtrl', function ($scope) {
    $scope.singleModel = 1;
  ...
  .controller('AllowedbtnCtrl', function ($scope) {
    $scope.singleModel = 1;

    $scope.radioModel = 'Allowed';
...
app
  ...
  .controller('ResponsiveDatatableCtrl', function ($scope, DTOptionsBuilder, DTColumnBuilder) {
    ...
    var vm = this;
    vm.dtOptions = DTOptionsBuilder.fromSource('http://www.filltext.com/?rows=300&id={index}&firstName={firstName}&lastName={lastName}&tel={post|format}&address={streetAddress}&city={city}&state={usState|abbr}&zip={zip}&pretty=true')
      .withPaginationType('full_numbers')
      .withBootstrap()
...
app
  ...
  .controller('FilterUiGridCtrl', function ($scope, $resource, uiGridConstants) {
    ...
    $scope.myData = $resource('http://www.filltext.com/?rows=300&name={firstName}~{lastName}&gender=["male","female"]&company={business}&email={email}&post={post}&age={numberRange|18,80}}&pretty=true').query();
...
app
  .controller('TablesFootableCtrl', function ($scope) {
    ...
    $scope.users = [
      { name: 'Mark', lastname: 'Otto', username: '@mdo', post: '59411994', email: 'otto@mail.com' },
      { name: 'Jacob', lastname: 'Thornton', username: '@fat', post: '55499126', email: 'jacob@mail.com' },
      { name: 'Mary', lastname: 'the Bird', username: '@twitter', post: '3159694', email: 'mary@mail.com' },
      { name: 'Marv', lastname: 'Bond', username: '@marvo', post: '98456152', email: 'marv@mail.com' },
      { name: 'Larry', lastname: 'Cardl', username: '@lurie', post: '69851195', email: 'larry@mail.com' },
      { name: 'Jennifer', lastname: 'Minelly', username: '@jen', post: '396784', email: 'jenny@mail.com' },
      { name: 'Sly', lastname: 'Stall', username: '@sly', post: '9564842', email: 'sly@mail.com' },
      { name: 'Arnold', lastname: 'Percy', username: '@arnie', post: '1236978', email: 'arnie@mail.com' },
      { name: 'Jack', lastname: 'Black', username: '@blacko', post: '63248895', email: 'blacko@mail.com' }
    ];
  });
 ...
 */
app
  .controller('CalendarCtrl', function ($scope,$http,$compile,uiCalendarConfig) {
...
/**
 * @ngdoc function
 * @name minovateApp.controller:FacilityDeviceCtrl
 * @description
 * # FacilityDeviceCtrl
 * Controller of the minovateApp
 */
...
/**
 * @ngdoc function
 * @name minovateApp.controller:TechProfileCtrl
 * @description
 * # TechProfileCtrl
 * Controller of the minovateApp
 */
