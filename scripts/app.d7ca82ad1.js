			...
			.state('app.subadmin.door.doors', {
			  ...
			  templateUrl: 'views/tmpl/subadmin/door/doors.html'
				...
				.state('app.subadmin.door.view-doors', {
				  ...
				  templateUrl: 'views/tmpl/subadmin/door/view-doors.html'
				})
		  ...
		  template: '<div ui-view></div>'
			...
			.state('app.admin.facility.facility', {
			  ...
			  templateUrl: 'views/tmpl/admin/facility/facility.html'
				...
				.state('app.admin.facility.facility-details', {
				  url: '/facility-details',
				  controller: 'FacilityDetailsCtrl',
				  templateUrl: 'views/tmpl/admin/facility/facility-details.html'
				})
...
app
  .controller('FacilityCtrl', function ($scope, $mdDialog, $http) {
	...
	$http.get('http://localhost/elika_admin/json/admin/facility.json').success(function(response){
	...
	$scope.imagePath = 'http://localhost/elika_admin/images/';
...
app
  .controller('FacilityDetailsCtrl', function ($scope, $mdDialog, $http) {
	...
	$http.get('http://localhost/elika_admin/json/admin/facility/devices.json').success(function(response){
	...
	$http.get('http://localhost/elika_admin/json/admin/facility/users.json').success(function(response){
 ...
 */
app
  .controller('UserCtrl', function ($scope, $mdDialog, $http) {
     $scope.page = {
      title: 'Users',
      subtitle: 'So much more to see at a glance.'
    };
	...
	$http.get('http://localhost/elika_admin/json/admin/users.json').success(function(response){
		$scope.users = response;
		$scope.totalDisplayed = 8;
 ...
 */
app
  .controller('DeviceCtrl', function ($scope, $mdDialog, $http) {
    $scope.page = {
		title: 'Devices',
		subtitle: 'So much more to see at a glance.'
    };
	...
	$http.get('http://localhost/elika_admin/json/admin/devices.json').success(function(response){
		$scope.devices = response;
		$scope.totalDisplayed = 8;
...
app
  .controller('DeviceDetailsCtrl', function ($scope, $mdDialog, $http) {
	...
	$http.get('http://localhost/elika_admin/json/admin/devices/dependent-devices.json').success(function(response){
		$scope.devices = response;
		$scope.totalDisplayed = 6;
	...
	$http.get('http://localhost/elika_admin/json/admin/devices/users.json').success(function(response){
		$scope.users = response;
		$scope.totalDisplayed1 = 6;
...
app
  .controller('DoorCtrl', function ($scope, $mdDialog, $http) {
	...
	$http.get('http://localhost/elika_admin/json/admin/doors.json').success(function(response){
		$scope.doors = response;
		$scope.totalDisplayed = 8;
		
		if($scope.doors.length > $scope.totalDisplayed) {
			$scope.lmbtn = {
				"display" : "block"
			};			
		} else {
		...
		$scope.loadMore = function () {				
			$scope.totalDisplayed += 8;
			if($scope.totalDisplayed >= $scope.doors.length) {
				$scope.lmbtn = {
					"display" : "none"
				};				
			}
...
app
  .controller('RoleCtrl', function ($scope, $http, $mdDialog) {
	...
	$http.get('http://localhost/elika_admin/json/admin/roles.json').success(function(response){
...
/**
 * @ngdoc function
 * @name minovateApp.controller:ScheduleCtrl
 * @description
 * # ScheduleCtrl
 * Controller of the minovateApp
 */
app
  .controller('ScheduleCtrl', function ($scope, $mdDialog, $http) {
	...
	$http.get('http://localhost/elika_admin/json/admin/schedules.json').success(function(response){
 ...
 */
app
  .controller('ScheduleGroupsCtrl', function ($scope, $mdDialog, $http) {
     $scope.page = {
...
/**
 * @ngdoc function
 * @name minovateApp.controller:HolidayScheduleCtrl
 * @description
 * # HolidayScheduleCtrl
 * Controller of the minovateApp
 */
...
/**
 * @ngdoc function
 * @name minovateApp.controller:ViewHolidayScheduleCtrl
 * @description
 * # ViewHolidayScheduleCtrl
 * Controller of the minovateApp
 */
app
 ...
 */
app
  .controller('TechnicianCtrl', function ($scope, $mdDialog, $http) {
     $scope.page = {
      title: 'Technician',
      subtitle: 'So much more to see at a glance.'
    };	
	...
	$http.get('http://localhost/elika_admin/json/admin/technician-users.json').success(function(response){
		$scope.users = response;
		$scope.totalDisplayed = 8;
...
/**
 * @ngdoc function
 * @name minovateApp.controller:MessageNotificationCtrl
 * @description
 * # MessageNotificationCtrl
 * Controller of the minovateApp
 */
app
...
/**
 * @ngdoc function
 * @name minovateApp.controller:DiagnosticsHelpCtrl
 * @description
 * # DiagnosticsHelpCtrl
 * Controller of the minovateApp
 */
...
/**
 * @ngdoc function
 * @name minovateApp.controller:HistoryEventsCtrl
 * @description
 * # HistoryEventsCtrl
 * Controller of the minovateApp
 */
...
app
  .controller('CameraDVRCtrl', function ($scope, $http) {
	...
	$scope.imagePath = 'http://localhost/elika_admin/videos';	
...
/**
 * @ngdoc function
 * @name minovateApp.controller:BillingInfoCtrl
 * @description
 * # BillingInfoCtrl
 * Controller of the minovateApp
 */
