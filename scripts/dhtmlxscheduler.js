...
function getOffsetRect(e) {
    var t = e.getBoundingClientRect(),
        ...
        r = window.pageYOffset || a.scrollTop || i.scrollTop,
        s = window.pageXOffset || a.scrollLeft || i.scrollLeft,
        n = a.clientTop || i.clientTop || 0,
        d = a.clientLeft || i.clientLeft || 0,
        l = t.top + r - n,
        o = t.left + s - d;
    return {
        top: Math.round(l),
...
window.dhtmlXScheduler = window.scheduler = {
    ...
    dtmlXMLLoaderObject.prototype.doXPathOpera = function(e, t) {
        ...
        for (var a = 0; a < e.length; a++)
            for (var r = 0; r < e[a].childNodes.length; r++) _isKHTML ? e[a].childNodes[r].tagName && e[a].childNodes[r].tagName.toUpperCase() == t && (i[i.length] = e[a].childNodes[r]) : e[a].childNodes[r].tagName == t && (i[i.length] = e[a].childNodes[r]);
        return i
    ...
    function() {
            ...
            if (c) {
                ...
                if (dhtmlx.message.keyboard) {
                    if (13 == i || 32 == i) {
                        ...
                        scheduler._getClassName(r).indexOf("dhtmlx_popup_button") > -1 && r.click ? r.click() : (e(c, !0),
                            a = !0)
                    }
                    27 == i && (e(c, !1), a = !0)
                }
        ...
        function a(e, t, i) {
            var a = scheduler._waiAria.messageButtonAttrString(e),
                r = i ? i : e || "",
                s = "dhtmlx_" + r.toLowerCase().replace(/ /g, "_") + "_button";
        ...
        function s(t, i, r) {
            ...
            var d = "",
                l = !1;
            if (t.width && (s.style.width = t.width), t.height && (s.style.height = t.height), t.title && (d += '<div class="dhtmlx_popup_title" id="' + n + '">' + t.title + "</div>", l = !0), d += '<div class="dhtmlx_popup_text" ' + (l ? "" : ' id="' + n + '" ') + "><span>" + (t.content ? "" : t.text) + '</span></div><div  class="dhtmlx_popup_controls">',
                i) {
            ...
            if (t.buttons)
                for (var _ = 0; _ < t.buttons.length; _++) d += a(t.buttons[_], _);
        ...
        function n(e, a, r) {
            ...
            return "top" == e.position ? n.style.top = "-3px" : n.style.top = l + "px",
        ...
        setUpdated: function(e, t, i) {
            if (!this._silent_mode) {
                ...
                r && "updated" == i && (i = r),
                    t ? (this.set_invalid(e, !1), this.updatedRows[a] = e, this.obj.setUserData(e, this.action_param, i), this._in_progress[e] && (this._in_progress[e] = "wait")) : this.is_invalid(e) || (this.updatedRows.splice(a, 1), this.obj.setUserData(e, this.action_param, "")), t || this._clearUpdateFlag(e), this.markRow(e, t, i), t && this.autoUpdate && this.sendData(e)
            }
        },
        ...
        markRow: function(e, t, i) {
            var a = "",
                r = this.is_invalid(e);
            if (r && (a = this.styles[r], t = !0), this.callEvent("onRowMark", [e, t, i, r]) && (a = this.styles[t ? i : "clear"] + a,
                    this.obj[this._methods[0]](e, a), r && r.details)) {
            ...
            if (e) {
                ...
                var i = new dtmlXMLLoaderObject(function(i, a, r, s, n) {
                        ...
                        if (t) d.push(t);
                            ...
                            for (var l in e) d.push(l);
                        return i.afterUpdate(i, n, d)
                    }, this, !0),
                    a = this.serverProcessor + (this._user ? getUrlSymbol(this.serverProcessor) + ["dhx_user=" + this._user, "dhx_version=" + this.obj.getUserData(0, "version")].join("&") : "");
                if ("GET" == this._tMode) i.loadXML(a + (-1 != a.indexOf("?") ? "&" : "?") + this.serialize(e, t));
                else if ("POST" == this._tMode) i.loadXML(a, !0, this.serialize(e, t));
                else if ("REST" == this._tMode) {
                    var r = this.getState(t),
                        s = a.replace(/(\&|\?)editing\=true/, "");
        ...
        afterUpdate: function(e, t, i) {
            if (window.JSON) try {
                var a = JSON.parse(t.xmlDoc.responseText),
                    r = a.action || this.getState(i) || "updated",
                    s = a.sid || i[0],
                    n = a.tid || i[0];
    ...
    function() {
        ...
        scheduler._waiAria = {
            getAttributeString: function(i) {
                var a = [" "];
                for (var r in i)
                    if ("function" != typeof i[r] && "object" != typeof i[r]) {
                        var s = t(e(i[r]));
                        a.push(r + "='" + s + "'")
                    }
            ...
            eventAttr: function(e, t) {
                !scheduler.config.readonly && scheduler.config.drag_move && (e.id != scheduler.getState().drag_id ? t.setAttribute("aria-grabbed", !1) : t.setAttribute("aria-grabbed", !0)),
            ...
            weekAgendaDayCell: function(e, t) {
                var i = e.querySelector(".dhx_wa_scale_bar"),
                    a = e.querySelector(".dhx_wa_day_data"),
                    r = scheduler.uid() + "";
        ...
        t = t || scheduler._currentDate(), i = i || "week", this._obj && this.unset_actions(), this._obj = "string" == typeof e ? document.getElementById(e) : e, this.$container = this._obj, this._skin_init && scheduler._skin_init(), scheduler.date.init(), this._els = [], this._scroll = !0, this._quirks = _isIE && "BackCompat" == document.compatMode, this._quirks7 = _isIE && -1 == navigator.appVersion.indexOf("MSIE 8"), this.get_elements(), this.init_templates(), this.set_actions(),
            this._init_once(), this._init_touch_events(), this.set_sizes(), scheduler.callEvent("onSchedulerReady", []), this.setCurrentView(t, i)
    }, scheduler.xy = {
        min_event_height: 40,
        scale_width: 50,
        scroll_width: 18,
        ...
        var e = this._x = this._obj.clientWidth - this.xy.margin_left,
            ...
            a = this._table_view ? -1 : this.xy.scale_width;
        ...
        e.style.width = Math.max(0, t) + "px", e.style.height = Math.max(0, i) + "px", arguments.length > 3 && (e.style.left = a + "px",
            e.style.top = r + "px")
    }, scheduler.get_elements = function() {
        for (var e = this._obj.getElementsByTagName("DIV"), t = 0; t < e.length; t++) {
            var i = scheduler._getClassName(e[t]),
                a = e[t].getAttribute("name") || "";
        ...
        this._obj.onselectstart = function(e) {
            ...
            var t = e || event,
                ...
                a = scheduler.callEvent("onContextMenu", [scheduler._locate_event(i), t]);
            return a
        }
        ...
        dhx_cal_data: function(e) {
            if (scheduler._ignore_next_click) return e.preventDefault && e.preventDefault(),
                e.cancelBubble = !0, scheduler._ignore_next_click = !1, !1;
            ...
            if (i && scheduler.config.select) {
                scheduler.select(i);
                var a = scheduler._getClassName(t); - 1 != a.indexOf("_icon") && scheduler._click.buttons[a.split(" ")[1].replace("icon_", "")](i)
        ...
        var d = new Date(t);
        s.valueOf() == d.valueOf() && d.setTime(d.valueOf() + r), a.start_date = a.start_date || s, a.end_date = a.end_date || d, a.text = a.text || this.locale.labels.new_event,
            a.id = this._drag_id = a.id || this.uid(), this._drag_mode = "new-size", this._loading = !0;
        ...
        if (this._cols) {
            ...
            if (t = a + (this._cols[t] ? (e - i) / this._cols[t] : 0), this._ignores && t >= this._cols.length)
        ...
        if (this._drag_mode) {
            ...
            if (this._is_pos_changed(this._drag_pos, t)) {
                ...
                if (scheduler.matrix && (d = scheduler.matrix[scheduler._mode]), d = d || {
                    ...
                    i = this._correct_shift(i), t._ignores && this.config.preserve_length && this._table_view ? (i = scheduler._correct_drag_start_date(i), a = scheduler._correct_drag_end_date(i, this._drag_event._event_length)) : a = l.end_date.valueOf() - (l.start_date.valueOf() - i);
                else {
                    if (i = l.start_date.valueOf(), a = l.end_date.valueOf(), this._table_view) {
                        ...
                        if ("month" == this._mode)
                            if (o = this._correct_shift(o, !1), this._drag_from_start) {
                                var h = 864e5;
                                o <= scheduler.date.date_part(new Date(a + h - 1)).valueOf() && (i = o - h);
                            } else a = o;
                        else t.resize_from_start ? i = scheduler._correct_drag_start_date(o) : a = scheduler._correct_drag_end_date(o, 0)
                    } else {
                        var _ = this.date.date_part(new Date(l.end_date.valueOf() - 1)).valueOf(),
                            c = new Date(_);
                    ...
                    else i >= a && (a = i + 6e4 * this.config.time_step)
                }
                var g = new Date(a - 1),
                    v = new Date(i);
                if ("move" == this._drag_mode && scheduler.config.limit_drag_out && (+v < +scheduler._min_date || +a > +scheduler._max_date)) {
                    if (+l.start_date < +scheduler._min_date || +l.end_date > +scheduler._max_date) v = new Date(l.start_date), a = new Date(l.end_date);
                    else {
                        var f = a - v; + v < +scheduler._min_date ? (v = new Date(scheduler._min_date), t._ignores && this.config.preserve_length && this._table_view ? (v = new Date(scheduler._correct_drag_start_date(v)),
                ...
                if (this._table_view || g.getDate() == v.getDate() && g.getHours() < this.config.last_hour || scheduler._allow_dnd)
                    if (l.start_date = v, l.end_date = new Date(a), this.config.update_render) {
        ...
        if (!e || 2 != e.button || !scheduler.config.touch) {
            if (this._drag_mode && this._drag_id) {
                ...
                var t = this._drag_id,
                    i = this._drag_mode,
                    a = !this._drag_pos || this._drag_pos.has_moved,
                    r = this.getEvent(this._drag_id);
                if (a && (this._drag_event._dhx_changed || !this._drag_event.start_date || r.start_date.valueOf() != this._drag_event.start_date.valueOf() || r.end_date.valueOf() != this._drag_event.end_date.valueOf())) {
                    ...
                    if (this.callEvent("onBeforeEventChanged", [r, e, s, this._drag_event]))
                        ...
                        } else this._new_event || this.callEvent(s ? "onEventAdded" : "onEventChanged", [t, this.getEvent(t)]);
                    else s ? this.deleteEvent(r.id, !0) : (this._drag_event._dhx_changed = !1,
        ...
        for (var e = ["dhx_cal_next_button", "dhx_cal_prev_button", "dhx_cal_tab", "dhx_cal_today_button"], t = 0; t < e.length; t++)
            for (var i = this._els[e[t]], a = 0; i && a < i.length; a++) {
                var r = i[a].getAttribute("name"),
                    s = this.locale.labels[e[t]];
        ...
        if (this.templates[this._mode + "_date"]) {
            ...
            t.className = "dhx_cal_data" + a, this._scales = {}, this._cols = [], this._colsS = {
                height: 0
            }, this._dy_shift = 0, this.set_sizes();
            var r, s, n = this._get_timeunit_start(),
            ...
            if (this._els.dhx_cal_date[0].innerHTML = l, this._waiAria.navBarDateAttr(this._els.dhx_cal_date[0], l), this._max_date = d, scheduler._render_scales(e, t), this._table_view) this._reset_month_scale(t, n, s);
            else if (this._reset_hours_scale(t, n, s), i.multi_day) {
                var o = "dhx_multi_day";
        ...
        if (s)
            for (var n = new Date(e), d = 0; t > d; d++) s(n) && (this._ignores_detected += 1, this._ignores[d] = !0, r && t++), n = scheduler.date.add(n, a, i), scheduler.date[i + "_start"] && (n = scheduler.date[i + "_start"](n))
        ...
        var r = scheduler.date.add(t, 1, "month"),
            s = scheduler._currentDate();
        ...
        for (var i = this.config.lightbox.sections, a = 0; a < i.length; a++)
            if (i[a].map_to == e)
                for (var r = i[a].options, s = 0; s < r.length; s++)
                    if (r[s].key == t) return r[s].label;
        return ""
        ...
        var a, r = t - e,
            s = i._start_correction + i._end_correction || 0,
        ...
        date_part: function(e) {
            var t = new Date(e);
            return e.setHours(0), e.setMinutes(0), e.setSeconds(0), e.setMilliseconds(0),
                e.getHours() && (e.getDate() < t.getDate() || e.getMonth() < t.getMonth() || e.getFullYear() < t.getFullYear()) && e.setTime(e.getTime() + 36e5 * (24 - e.getHours())), e
        },
        ...
        str_to_date: function(e, t) {
            for (var i = "var temp=date.match(/[a-zA-Z]+|[0-9]+/g);", a = e.match(/%[a-zA-Z]/g), r = 0; r < a.length; r++) switch (a[r]) {
                ...
                case "%s":
                    ...
                    break;
                case "%M":
                    i += "set[1]=scheduler.locale.date.month_short_hash[temp[" + r + "]]||0;";
                    break;
                case "%F":
                    i += "set[1]=scheduler.locale.date.month_full_hash[temp[" + r + "]]||0;"
            }
            var s = "set[0],set[1],set[2],set[3],set[4],set[5]";
            return t && (s = " Date.UTC(" + s + ")"),
        ...
        getISOWeek: function(e) {
            ...
            var a = i.getFullYear(),
                r = Math.round((i.getTime() - new Date(a, 0, 1).getTime()) / 864e5),
                s = 1 + Math.floor(r / 7);
            return s
        },
        ...
        e.dhx_save_btn = e.icon_save,
            e.dhx_cancel_btn = e.icon_cancel, e.dhx_delete_btn = e.icon_delete;
    ...
    function() {
        ...
        if (t) {
            var i = e.start_date.getHours(),
                a = e.end_date.getHours() + e.end_date.getMinutes() / 60,
                r = this.config.last_hour,
                s = this.config.first_hour,
                n = this._table_view || !((a > r || s > a) && (i >= r || s > i));
            if (n) return !0;
        ...
        for (var t = this._rendered_location, i = this._lame_clone(e), a = e._sday; a < e._eday; a++) {
            ...
            var r = scheduler.date,
                s = scheduler._min_date;
            s = r.add(s, i._sweek, "week"), s = r.add(s, i._sday, "day");
            var n = scheduler.getEvents(s, r.add(s, 1, "day")).length,
    ...
    scheduler.render_data = function(e, t) {
        ...
        if (e = this._table_view ? this._pre_render_events_table(e, t) : this._pre_render_events_line(e, t), this._table_view)
            if (t) this._colsS.heights = a;
                ...
                if (n.rows) {
                    ...
                    var v = (n.parentNode.childNodes, (r[0] + 1) * i + 1),
                        f = v,
                        m = v + "px";
        ...
        for (var r = 0; r < e.length; r++) {
            var s = e[r],
                ...
                l = n.getHours(),
                o = d.getHours();
            if (s._sday = this._get_event_sday(s), this._ignores[s._sday]) e.splice(r, 1), r--;
            else {
        ...
        for (var i, a = [], r = [
                ...
                [],
                []
            ], s = this._colsS.heights, n = this._cols.length, d = {}, l = 0; l < e.length; l++) {
            var o = e[l],
                h = o.id;
            d[h] || (d[h] = {
                first_chunk: !0,
            ...
            if (o._sday = g % n, !this._ignores[o._sday] || !o._timed) {
                ...
                if (o._sorder && t || (o._sorder = f), o._sday + o._length <= n) i = null, a.push(o), m[f] = o, s[o._sweek] = m.length - 1, o._first_chunk = _.first_chunk, o._last_chunk = _.last_chunk;
                else {
        ...
        var i = 60 * e.start_date.getHours() + e.start_date.getMinutes(),
            a = 60 * e.end_date.getHours() + e.end_date.getMinutes() || 60 * scheduler.config.last_hour,
            r = this._y_from_date(e.start_date),
            s = Math.max(t, (a - i) * this.config.hour_size_px / 60);
        return {
            top: r,
            height: s
        }
        ...
        if (!(e._sday < 0)) {
            ...
            if (a) {
                var r = this._calc_event_y(e, scheduler.xy.min_event_height),
                    s = r.top,
                    n = r.height,
                    d = e._count || 1,
                    l = e._sorder || 0,
                    o = Math.floor((a.clientWidth - i) / d),
                    h = l * o + 1;
        ...
        if (s) {
            ...
            var v = e.color ? "background:" + e.color + ";" : "",
                ...
                m = ["position:absolute", "top:" + a + "px", "left:" + r + "px", "width:" + (s - r - 15) + "px", f, v, e._text_style || ""].join(";"),
        ...
        for (var a = e.target || e.srcElement, r = ""; a;) {
            if (r = scheduler._getClassName(a)) {
                ...
                if (s >= 0) {
                    if (!i) return a;
                    var n = 0 === s || !scheduler._trim(r.charAt(s - 1)),
                        d = s + t.length >= r.length || !scheduler._trim(r.charAt(s + t.length));
                    if (n && d) return a
                }
            }
            a = a.parentNode
    ...
    scheduler.ical = {
        ...
        parse_param: function(e, t) {
            ...
            if (-1 != i) {
                var a = e.substr(0, i).toLowerCase(),
                    r = e.substr(i + 1).replace(/\\\,/g, ",").replace(/[\r\n]+$/, "");
        ...
        parse_date: function(e, t, i) {
            var a = e.split("T");
            a[1] && (t = a[1].substr(0, 2), i = a[1].substr(2, 2));
            var r = a[0].substr(0, 4),
                s = parseInt(a[0].substr(4, 2), 10) - 1,
                n = a[0].substr(6, 2);
            return scheduler.config.server_utc && !a[1] ? new Date(Date.UTC(r, s, n, t, i)) : new Date(r, s, n, t, i)
        },
    ...
    scheduler.formSection = function(e) {
        ...
        select: {
            ...
            set_value: function(e, t, i, a) {
                var r = e.firstChild;
                !r._dhx_onchange && a.onchange && (r.onchange = a.onchange, r._dhx_onchange = !0), "undefined" == typeof t && (t = (r.options[0] || {}).value),
                    r.value = t || ""
            },
            get_value: function(e, t) {
                ...
                for (var n = "", d = 0; d < t.length; d++) {
                    ...
                    switch (l) {
                        ...
                        case "%H:%i":
                            ...
                            for (e._time_values = []; r > _;) {
                                ...
                                o += "<option value='" + _ + "'>" + u + "</option>",
                                    e._time_values.push(_), a.setTime(a.valueOf() + 60 * this.config.time_step * 1e3);
                    ...
                    if (o) {
                        var v = scheduler._waiAria.lightboxSelectAttrString(l),
                            f = e.readonly ? "disabled='disabled'" : "";
        ...
        for (var l = this.config.lightbox.sections, o = 0; o < l.length; o++) {
            var h = l[o],
                _ = document.getElementById(h.id).nextSibling,
        ...
        for (var t = this.config.lightbox.sections, i = 0; i < t.length; i++) {
            ...
            a = a ? a.nextSibling : a;
            var r = this.form_blocks[t[i].type],
                s = r.get_value.call(this, a, e, t[i]);
            ...
            if (t && i) switch (i) {
                ...
                default:
                    if (t.getAttribute("dhx_button")) scheduler.callEvent("onLightboxButton", [i, t, e]);
                        ...
                        var r, s, n; - 1 != i.indexOf("dhx_custom_button") && (-1 != i.indexOf("dhx_custom_button_") ? (r = t.parentNode.getAttribute("index"), n = t.parentNode.parentNode) : (r = t.getAttribute("index"), n = t.parentNode, t = t.firstChild)), r && (s = scheduler.form_blocks[scheduler.config.lightbox.sections[r].type],
        ...
        if (!this._lightbox) {
            ...
            for (var r = 0; r < s.length; r++) {
                ...
                if (c.id && document.getElementById(c.id)) {
                    var u = document.getElementById(c.id),
        ...
        a(document.body, e[0], function(e) {
            ...
            if (!i(e)) {
                ...
                if (u = r, !_ && !h && scheduler.config.touch_drag) {
                    var s = scheduler._locate_event(document.activeElement),
                        n = scheduler._locate_event(a.target),
        ...
        if (!scheduler.skin || "classic" !== scheduler.skin && "glossy" !== scheduler.skin || (a = 1), this._configure(scheduler.config, scheduler._skin_settings, a), this._configure(scheduler.xy, scheduler._skin_xy, a), "flat" === scheduler.skin && (scheduler.xy.scale_height = 35, scheduler.templates.hour_scale = function(e) {
            ...
            r && (r.padding = 14), scheduler.templates.event_bar_date = function(e, t, i) {
                ...
                if (scheduler.templates.month_day = function(i) {
                        if ("month" == this._mode) {
                            var a = e(i);
                            return 1 == i.getDate() && (a = scheduler.locale.date.month_full[i.getMonth()] + " " + a), +i == +scheduler.date.date_part(this._currentDate()) && (a = scheduler.locale.labels.dhx_cal_today_button + " " + a), a
                        }
                ...
                return this.each(function() {
                    if (this && this.getAttribute && !this.getAttribute("dhxscheduler")) {
                        ...
                        this.getElementsByTagName("div").length || (this.innerHTML = '<div class="dhx_cal_navline"><div class="dhx_cal_prev_button">&nbsp;</div><div class="dhx_cal_next_button">&nbsp;</div><div class="dhx_cal_today_button"></div><div class="dhx_cal_date"></div><div class="dhx_cal_tab" name="day_tab" style="right:204px;"></div><div class="dhx_cal_tab" name="week_tab" style="right:140px;"></div><div class="dhx_cal_tab" name="month_tab" style="right:76px;"></div></div><div class="dhx_cal_header"></div><div class="dhx_cal_data"></div>',
                            this.className += " dhx_cal_container"), scheduler.init(this, scheduler.config.date, scheduler.config.mode), i.data && scheduler.parse(i.data), a.push(scheduler)
                    }
                }), 1 === a.length ? a[0] : a
            }
        ...
        var t = scheduler.setCurrentView,
            ...
            s = function(t, s) {
                ...
                window.clearTimeout(r), window.clearTimeout(a), e(this, t, s), r = setTimeout(function() {
                    n.callEvent("onBeforeViewChange", [n._mode, n._date, s || n._mode, t || n._date]) && (i.call(n, t, s), n.callEvent("onViewChange", [n._mode, n._date]), window.clearTimeout(a), r = 0)
